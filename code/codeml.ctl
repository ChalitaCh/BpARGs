    seqfile = amrA.all.phy
     treefile = amrA.all.aln.treefile
      outfile = amrA.model0.noSE.txt
    ...
    fix_kappa = 0   * 1: kappa fixed, 0: kappa to be estimated
        kappa = 1.93165   * initial or fixed kappa
    fix_omega = 0   * 1: omega or omega_1 fixed, 0: estimate 
        omega = 0.01149   * initial or fixed omega, for codons or codon-transltd AAs
